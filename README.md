...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    React JS is a library that aims to solve the problem of developing a large application that has temporal data changes.

1. Describe component state.

    Component state is where you store property balues that belong to the component.
